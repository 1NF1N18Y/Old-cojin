...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cojin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cojin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cojin transaction") + "\n" +
              "  cojin-tx [options] -create [commands]   " + _("Create hex-encoded cojin transaction") + "\n" +
              "\n";
